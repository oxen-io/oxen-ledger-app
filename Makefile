...
DEFINES   += LOKI_VERSION_MAJOR=$(APPVERSION_M) LOKI_VERSION_MINOR=$(APPVERSION_N) LOKI_VERSION_MICRO=$(APPVERSION_P)
DEFINES   += LOKI_VERSION_STRING=\"$(APPVERSION)\"
